...
title: |
  ...
  Real-time Remote Sensing Algal Bloom Report: 9/27-10/14
editor_options:
...
# apply water mask mndwi threshold
# df <- df %>%
#   mutate(water_nir_red = case_when(mndwi >= mndwi_thresh ~ nir_red_br,
#                                    TRUE ~ 0)) %>%
#   # make values NA if they were 0
#   mutate_at(c('water_nir_red'), ~na_if(., 0))
...
The NIR:Red ratio exceeded 1, indicating presence of higher algal concentrations (which may affect taste and odor of water), in at least one area of the following reservoirs between `r date2minus14` and `r date2`:
...
An asterisk (*) indicates reservoirs that had less than three satellite observations between `r date2minus14` and `r date2`.
...
The FAI-NDWI algorithm met the conditions for cyanobacteria (indicating possible occurance of harmful algal blooms) in at least one area for the following reservoirs between `r date2minus14` and `r date2`:
...
The two algorithms employed in the analysis tell us two different things. The NIR:Red ratio increases as algal concentrations increases. Dense concentrations of algae on the water surface can yield taste and odor issues. The FAI and NDWI algorithms together can evaluate cyanobacteria presence, which can potentially indicate cyanotoxins that create harmful algal blooms. 
...
Please note however that there are only four instances of satellite observations during this two week period.
...
The first map below depicts the average value of the NIR:Red ratio at each colored pixel. This is different than the other maps, which show the total number of times the pixel exceeded the established threshold.
...
Please note however that there are only four instances of observations during this two week time period.
...
[6/21-7/05 Report](https://rachel-lynker.github.io/denverwater_algae/index-6.21_7.5.html)

[7/05-7/19 Report](https://rachel-lynker.github.io/denverwater_algae/index-7.5_7.19.html)

[7/19-8/02 Report](https://rachel-lynker.github.io/denverwater_algae/index-7.19_8.2.html)

[8/2-8/16 Report](https://rachel-lynker.github.io/denverwater_algae/index-8.2_8.16.html)

[8/16-8/30 Report](https://rachel-lynker.github.io/denverwater_algae/index-8.16_8.30.html)

[8/30-9/13 Report](https://rachel-lynker.github.io/denverwater_algae/index-8.30_9.13.html)

[9/13-9/26 Report](https://rachel-lynker.github.io/denverwater_algae/index-9.13_9.26.html)
