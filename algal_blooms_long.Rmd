...
date1 <- "2020-04-01 to 2020-10-30"
date2 <- "2021-04-01 to 2021-10-30"

# Read csv data into R
df <- read.csv(paste0(drive_dir, "/pts_", year, "_sentinel2_toa_may19.csv"))
...
# Export as RDS file
df %>% 
  saveRDS(paste0(drive_dir, "sensors_all_aggregated_", year, ".RDS"))
