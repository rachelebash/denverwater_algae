...
title: |
  ...
  Real-time Remote Sensing Algal Bloom Report: 8/30 - 9/13
editor_options:
...
date1 <- "2022-04-01"
date2 <- "2022-09-13"
date2minus14 <- "2022-08-30"

# Read csv data into R
df <- read.csv(paste0(drive_dir, "/pts__sentinel2_toa_", date1, "_", date2, "_water_mask.csv"))
