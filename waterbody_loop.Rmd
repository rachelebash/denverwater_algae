...
```{r echo = FALSE, results = 'asis', tab.cap = "Mapped exceedances for each point location in {{value.to.match}}. NIR:Red values greater than 1 indicate an exceedance and FAI-NDWI output values greater than 0.63 indicate an exceedance."}
