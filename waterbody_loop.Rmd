The following images are maps showing potential harmful algal blooms in {{value.to.match}} from `r date1` and `r date2`.
...
gee <- readRDS(paste0(drive_dir, "sensors_all_aggregated_2021.RDS"))
...
nir_paths <- Sys.glob(paste0(drive_dir, "/nir_red/*.jpg"))
...
over_thresh <- gee %>% 
  ...
  rename("Point location" = "sampling_p",
         ...
         "NIR:Red threshold exceedance" = "nir_red_n_over",
         "FAI-NDWI threshold exceedance" = "fai_ndwi_n_over",
         "FAI-NDWI threshold exceedance (%)" = "fai_ndwi_pct_over",
         "NIR:Red threshold exceedance (%)" = "nir_red_pct_over") 
```
